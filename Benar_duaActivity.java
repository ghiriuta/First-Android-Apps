...
public class Benar_duaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_benar_dua);
        ...
        t_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View view) {
                Intent MenuActivityIntent = new Intent (Benar_duaActivity.this, MenuActivity.class);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick (View view) {
                Intent Test_tigaActivityIntent = new Intent (Benar_duaActivity.this, Test_tigaActivity.class);
