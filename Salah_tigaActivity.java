...
public class Salah_tigaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_salah_tiga);
        ...
        t_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View view) {
                Intent MenuActivityIntent = new Intent (Salah_tigaActivity.this, MenuActivity.class);
        ...
        prev.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick (View view) {
                Intent Test_tigaActivityIntent = new Intent (Salah_tigaActivity.this, Test_tigaActivity.class);
