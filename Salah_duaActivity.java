...
public class Salah_duaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View view) {
                Intent MenuActivityIntent = new Intent (Salah_duaActivity.this, MenuActivity.class);
        ...
        prev.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick (View view) {
                Intent Test_duaActivityIntent = new Intent (Salah_duaActivity.this, Test_duaActivity.class);
